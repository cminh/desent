package com.example.celine.desent.activities;
...
import com.example.celine.desent.views.EstimationButton;
import com.example.celine.desent.models.Indicator;
import com.example.celine.desent.R;
import com.example.celine.desent.views.CircularIndicator;
import com.example.celine.desent.fragments.CategoryFragment;
import com.example.celine.desent.fragments.CircleFragment;
import com.example.celine.desent.fragments.MonthFragment;
import com.example.celine.desent.fragments.WeekFragment;
...
public class MainActivity extends Activity {
    ...
    protected void setUp() {
        ...
        try {
            date = dateFormat.parse("2017-02-04");
        ...
        //Estimation buttons
        solarPanelButton = findViewById(R.id.solarPanelButton);
        solarPanelButton.setCaption("with a solar installation");
        walkButton = findViewById(R.id.walkingButton);
        walkButton.setCaption("walking 5km instead of driving");
        cycleButton = findViewById(R.id.cyclingButton);
        cycleButton.setCaption("cycling 5km instead of driving");
        electricCarButton = findViewById(R.id.electricCarButton);
